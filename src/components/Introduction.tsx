...
const Introduction = () => {
  return (
   <section className="relative flex flex-col md:flex-row items-center justify-center px-6 md:px-20 py-10 min-h-0 overflow-hidden text-gray-900 dark:text-white transition-colors duration-300">
      ...
      >
        {/* Halo doux */}
        <div className="absolute -inset-2 bg-blue-500 rounded-3xl blur-xl opacity-20 dark:opacity-30"></div>

        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-300/20 dark:border-white/10 bg-gray-100 dark:bg-gray-800 backdrop-blur-md hover:scale-105 transition-transform duration-300">
          <img
            src={profilePic}
            alt="Portrait"
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="mt-8 inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-6 py-3 rounded-full font-medium shadow-lg transition-all duration-300"
        >
